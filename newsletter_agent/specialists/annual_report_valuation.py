...
def compute_dcf_scenarios(
    ...
    cagr_spread = max(abs(base_cagr) * 0.35, 0.02)
    bear_cagr = max(base_cagr - cagr_spread, -0.10)
    bull_cagr = min(base_cagr + cagr_spread, 0.20)
    base_cagr_sc = max(min(base_cagr, 0.20), -0.10)
