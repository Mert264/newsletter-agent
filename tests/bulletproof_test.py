...
PROMPTS = {
    ...
    13: {"brief": "Sammenlign den globale inflationsudvikling — USA, Euroområdet, UK og Japan — headline CPI/HICP år-over-år i procent. Brug følgende serier alle i macro-specialist: CPALTT01USM659N (source='fred', label='USA'), ea_hicp_yoy (source='eurostat_ts', label='Euroområdet'), CPALTT01GBM659N (source='fred', label='UK'), CPALTT01JPM659N (source='fred', label='Japan'). Alle serier er allerede i YoY % — sæt y_label='%'. Brug titlen 'Inflationsudvikling i USA, euroområdet, UK og Japan (headline CPI/HICP)'. Tilføj reference_lines: [{y: 2.0, label: '2%-mål', color: '#9ca3af'}] på Type A-figuren. På den tilhørende Type D-tabel: sæt target_value: 2.0 så kolonnen viser 'Afstand til 2%-mål' i stedet for periodisk ændring, og sæt col_after='Nu'. Tilføj til note: 'Japans data slutter tidligere end de øvrige lande grundet forsinkelse i OECD-datapublikation.' Vis inflationstoppen i 2021–2022, disinflationen og nærheden til centralbankernes 2%-mål.",
