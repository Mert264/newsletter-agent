...
PROMPTS = {
    ...
    13: {"brief": "Sammenlign den globale inflationsudvikling — USA, Euroområdet, Storbritannien og Japan — headline inflation år-over-år i procent. Brug CPALTT01USM659N for USA (FRED, macro-specialist), ea_hicp_yoy for Euroområdet (Eurostat HICP EA-aggregat, eurostat-specialist, label='Euroområdet'), CPALTT01GBM659N for UK (FRED, macro-specialist), CPALTT01JPM659N for Japan (FRED, macro-specialist). Alle serier er allerede i YoY % — sæt y_label='%'. Placer chart-spec under macro-specialist; inkludér 'Euroområdet' i series_labels (pipeline merger data på tværs af specialister automatisk). Vis inflationstoppen i 2021–2022, disinflationen og nærheden til 2%-målet.",
