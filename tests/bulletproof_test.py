...
PROMPTS = {
    ...
    13: {"brief": "Sammenlign den globale inflationsudvikling — USA, Euroområdet, Storbritannien og Japan — headline CPI/HICP år-over-år i procent. Brug CPIAUCSL for USA (BLS index, FRED, macro-specialist), CP0000EZ19M086NEST for Euroområdet (ECB HICP index, FRED, macro-specialist), CP0000GB2HIGY01OECD for UK (HICP index, FRED, macro-specialist), JPNCPIALLMINMEI for Japan (OECD CPI index, FRED, macro-specialist). Alle fire serier er råindeks — sæt y_label='YoY %' på chart-spec (pipeline beregner år-over-år automatisk) og period_days>=760. Vis inflationstoppen i 2021–2022, disinflationen og nærheden til 2%-målet.",
