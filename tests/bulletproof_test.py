...
PROMPTS = {
    ...
    9:  {"brief": "Vis EU's energimix fordelt på energikilder: naturgas, kul, kerneenergi, vind, sol og vandkraft. Vis den procentvise andel af det samlede energiforbrug for hvert brændstof.",
         "period": 0, "label": "EU energimix"},
    ...
    13: {"brief": "Sammenlign den globale inflationsudvikling — USA, euroområdet, Storbritannien og Japan — headline CPI år-over-år i procent (brug CPALTT01USM659N, CPALTT01EZM659N, CPALTT01GBM659N, CPALTT01JPM659N fra FRED via macro-specialist, sæt y_label='%'). Vis inflationstoppen i 2021–2022, disinflationen og nærhed til 2%-målet.",
         "period": 0, "label": "Global inflation — US, EU, UK, JP"},
